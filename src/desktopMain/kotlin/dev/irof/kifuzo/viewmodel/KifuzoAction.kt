...
sealed class KifuzoAction {
    ...
    data class UpdateMetadata(val path: Path, val event: String, val startTime: String) : KifuzoAction()
    data class ShowEditMetadataDialog(val path: Path) : KifuzoAction()
    ...
    data class FileDrop(val path: Path) : KifuzoAction()
